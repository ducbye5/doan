...
<div role="main" class="main"></div>
			<section class="main-slide">
				<div id="owl-main-slide" class="owl-carousel pgl-main-slide" data-plugin-options='{"autoPlay": true}'>
					<div class="item" id="item1"><img src="{{ asset('images/slides/slider1.jpg') }}" alt="Photo" class="img-responsive">
					...
					<div class="item" id="item2"><img src="{{ asset('images/slides/slider2.jpg') }}"" alt="Photo" class="img-responsive">
						<div class="item-caption">
							<div class="container">
								<div class="property-info">
									<span class="property-thumb-info-label">
					...
					<div class="item" id="item3"><img src="{{ asset('images/slides/slider3.jpg') }}"" alt="Photo" class="img-responsive">
						<div class="item-caption">
							<div class="container">
								<div class="property-info">
									<span class="property-thumb-info-label">
								...
								<div class="row pgl-midnarrow-row">
									<div class="col-xs-5">
										<div class="img-thumbnail-medium">
											<a href="agentprofile.html"><img src="{{ asset('images/agents/temp-agent.png') }}" class="img-responsive" alt=""></a>
										</div>
									</div>
									<div class="col-xs-7">
						...
						<div class="col-md-4 animation about-item">
							...
							<div class="owl-carousel pgl-bg-dark pgl-testimonial" data-plugin-options='{"items": 1, "pagination": false, "autoHeight": true}'>
								...
								<div class="col-md-12">
									<div class="testimonial-author">
										<div class="img-thumbnail-small img-circle">
											<img src="{{ asset('images/agents/agent-1.jpg') }}" class="img-circle" alt="John Smith">
										</div>
										<h4>John Smith</h4>
										<p><strong>Selller</strong></p>
									</div>
