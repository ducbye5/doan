...
<div role="main" class="main pgl-bg-grey">
	@php
		$data_picture = explode(';',$property['news_picture']);
		if($property['news_basic_info_unit'] == 'Negotiate'){
			$cost = 'Negotiate';
		}else{
			$cost = '$ '.number_format($property['news_basic_info_total_price']);
		}
		$type_of_cost = $property['news_calendar_typeofcost']??'';
		$title = strtoupper($property['news_basic_info_title']);
		$address = $property['news_basic_info_address'];
		$area = $property['news_basic_info_acreage'];
		$type = strtoupper($property['news_basic_info_type']);
		$type_of_property = str_replace('_',' ',$property['news_basic_info_typeofproperties']);
		$bedrooms = $property['news_other_info_numberbedrooms'];
		$bathrooms = $property['news_other_info_numbertoilets'];
		$description = $property['news_description_info'];
		$facade = $property['news_other_info_facade'];
		$directionbalcony = $property['news_other_info_directionbalcony'];
		$directionhouse = $property['news_other_info_directionhouse'];
		$numberfloors = $property['news_other_info_numberfloors'];
		$contact_mobilephone = $property['news_contact_info_mobilephone'];
		$contact_email = $property['news_contact_info_email'];
		$contact_name = $property['news_contact_info_name']; 
		$contact_address = $property['news_contact_info_address'];
	@endphp
				...
				<div class="row">
					<div class="col-md-9 content">
						...
						<section class="pgl-pro-detail pgl-bg-light">
							<div id="slider" class="flexslider">
								<ul class="slides">
									...
									<li>
										<img src="{{ asset('upload/image/news/'.$picture) }}" alt="">
							...
							<div id="carousel" class="flexslider">
								<ul class="slides">
									@foreach($data_picture as $picture)
									<li> <img src="{{ asset('upload/image/news/'.$picture) }}" alt=""></li>
									@endforeach
								</ul>
							</div>
								...
								<div class="row">
									<div class="col-sm-4">
										<ul class="list-unstyled amenities amenities-detail">
											<li><strong>Type:</strong> {{ $type_of_property }}</li>
											<li><strong>Area:</strong> {{ $area }}<sup>m²</sup></li>
											<li><address><i class="icons icon-location"></i> {{ $address }}</address></li>
											<li><i class="icons icon-bedroom"></i> {{ $bedrooms }}</li>
											<li><i class="icons icon-bathroom"></i> {{ $bathrooms }}</li>
										</ul>
									</div>
									<div class="col-sm-8">
										<h2>{{ $title }}</h2>
									...
									<div class="panel-group" id="accordion">
										<div class="panel panel-default pgl-panel">
											<div class="panel-heading">
												<h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#additional_details">Additional Details</a> </h4>
											</div>
											<div id="additional_details" class="panel-collapse collapse in">
												<div class="panel-body">
													<ul>
														<li><strong>Facade :</strong> {{ $facade }}</li>
														<li><strong>Direction balcony :</strong> {{ $directionbalcony }}</li>
														<li><strong>Direction house :</strong> {{ $directionhouse }}</li>
														<li><strong>Number of floors :</strong> {{ $numberfloors }}</li>
													</ul>
												</div>
											</div>
										</div>
										<div class="panel panel-default pgl-panel">
											<div class="panel-heading">
												<h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#contact_information" class="collapsed">Contact Information</a> </h4>
											</div>
											<div id="contact_information" class="panel-collapse collapse">
												<div class="panel-body">
													<ul>
														<li><strong>Name :</strong> {{ $contact_name }}</li>
														<li><strong>Mobilephone :</strong> {{ $contact_mobilephone }}</li>
										...
										<div class="panel panel-default pgl-panel">
											<div class="panel-heading">
												<h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#property_detail_video" class="collapsed">Video</a> </h4>
											</div>
											<div id="property_detail_video" class="panel-collapse collapse">
										...
										<div class="panel panel-default pgl-panel">
											<div class="panel-heading">
												<h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#property_detail_map" class="collapsed">Map</a> </h4>
											</div>
											<div id="property_detail_map" class="panel-collapse collapse">
												<div class="panel-body">
										...
										<div class="panel panel-default pgl-panel">
											<div class="panel-heading">
												<h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#property_detail_broker" class="collapsed">Broker</a> </h4>
											</div>
											<div id="property_detail_broker" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="pgl-agent-item pgl-bg-light">
														<div class="row pgl-midnarrow-row">
															<div class="col-xs-4">
																<div class="img-thumbnail-medium">
																	<a href="agentprofile.html"><img alt="" class="img-responsive" src="{{ asset('images/agents/temp-agent.png') }}"></a>
																</div>
															</div>
															<div class="col-xs-8">
						...
						<section class="pgl-properties">
							<h2>Property in the same city</h2>
							<div class="row">
								<div class="owl-carousel pgl-pro-slide" data-plugin-options='{"items": 3, "itemsDesktop": 3, "singleItem": false, "autoPlay": false, "pagination": false}'>
									@foreach($listPropertyInTheSameCity as $data)
									@php
										$id = $data['id'];
										...
										$bedrooms = $data['news_other_info_numberbedrooms'];
										$bathrooms = $data['news_other_info_numbertoilets'];
									@endphp
										...
										<div class="pgl-property">
											<div class="property-thumb-info">
												...
												<div class="property-thumb-info-content">
													<h3><a href="{{ route('properties.detail',['id' => $id]) }}" class="text-red">{{ $title }}</a></h3>
